...
})({"9y5sQ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "02c427a9e37416e3";
"use strict";
...
},{}],"kZg5U":[function(require,module,exports) {
...
function GetAllProducts() {
    ...
    (0, _database.get)((0, _database.child)(dbref, "products")).then((snapshot)=>{
...
function AssignImgToFilesArray(thefiles) {
    ...
    for(let i = 0; i < looplim; i++)// Files.push(TheFiles[i])
...
function UploadAnImage(imgToUpload, imgNo) {
    ...
    const storageRef = (0, _storage.ref)(storage, ImageAddress);
...
function UploadAProduct() {
    (0, _database.set)((0, _database.ref)(realdb, "products/" + getShortTitle()), {
        Id: getShortTitle(),
...
function GetAllCategories() {
    const dbref = (0, _database.ref)(realdb);
    (0, _database.get)((0, _database.child)(dbref, "categories")).then((snapshot)=>{
        snapshot.forEach((prod)=>{
...
document.addEventListener("click", function(e) {
    if (e.target.matches("#edit_item")) {
        ...
        delet.addEventListener("click", function(e) {
            ...
            if (confirm("bạn c\xf3 muốn x\xf3a loại h\xe0ng c\xf3 t\xean " + ArrayOfProducts[i - 1].ProductTitle + " kh\xf4ng") == true) {
                (0, _database.remove)((0, _database.ref)(realdb, "products/" + ArrayOfProducts[i - 1].Id)).then(()=>{
                    alert("data removed");
                });
                location.reload();
            }
        ...
        edit.addEventListener("click", function(e) {
            if (confirm("bạn muốn cập nhật loại h\xe0ng " + ArrayOfProducts[i - 1].ProductTitle + " ?") == true) (0, _database.update)((0, _database.ref)(realdb, "products/" + ArrayOfProducts[i - 1].Id), {
...
},{"firebase/app":"aM3Fo","firebase/storage":"8WX7E","firebase/database":"SJ4UY"}]},["9y5sQ","kZg5U"], "kZg5U", "parcelRequirea107")

//# sourceMappingURL=index.e37416e3.js.map
