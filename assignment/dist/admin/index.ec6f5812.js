...
})({"6Cmpp":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9c5cd2a5ec6f5812";
"use strict";
...
},{}],"jWTBj":[function(require,module,exports) {
...
document.addEventListener("click", function(e) {
    if (e.target.matches("#delete_item")) {
        ...
        delet.addEventListener("click", function() {
            ...
            if (confirm("bạn c\xf3 muốn x\xf3a loại h\xe0ng c\xf3 t\xean " + ArrayOfProducts[i - 1].name + " kh\xf4ng") == true) {
                (0, _database.remove)((0, _database.ref)(realdb, "categories/" + ArrayOfProducts[i - 1].id)).then(()=>{
                    alert("data removed");
                });
                location.reload();
            }
        ...
        edit.addEventListener("click", function(e) {
            if (confirm("bạn muốn cập nhật loại h\xe0ng " + ArrayOfProducts[i - 1].name + " ?") == true) (0, _database.update)((0, _database.ref)(realdb, "categories/" + ArrayOfProducts[i - 1].id), {
        ...
        add.addEventListener("click", ()=>{
            let i = 0;
            if (name.value == "" || category_id.value == "") return alert("Name or ID empty");
            if (confirm("bạn c\xf3 muốn th\xeam loại h\xe0ng " + name.value) == true) (0, _database.set)((0, _database.ref)(realdb, "categories/" + category_id.value), {
...
},{"firebase/app":"aM3Fo","firebase/database":"SJ4UY"}]},["6Cmpp","jWTBj"], "jWTBj", "parcelRequirea107")

//# sourceMappingURL=index.ec6f5812.js.map
