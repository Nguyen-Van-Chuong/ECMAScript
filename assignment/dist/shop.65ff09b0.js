...
})({"88jB2":[function(require,module,exports) {
    ...
    label.forEach((item)=>{
        ...
        item.addEventListener("click", ()=>{
            if (item.checked == true && item.value == "1") {
                // ArrayOfProducts = []
                que = (0, _database.query)((0, _database.ref)(realdb, "products"), (0, _database.orderByChild)("Price"), (0, _database.startAt)(200), (0, _database.endAt)(500));
                (0, _database.get)(que).then((snapshot)=>{
                    // let ArrayOfProducts = []
                ...
                que = (0, _database.query)((0, _database.ref)(realdb, "products"));
                (0, _database.get)(que).then((snapshot)=>{
                    // let ArrayOfProducts = []
                    snapshot.forEach((childSnapshot)=>{
                        ArrayOfProducts.push(childSnapshot.val());
...
},{"firebase/app":"aM3Fo","firebase/storage":"8WX7E","firebase/database":"SJ4UY"}]},["88jB2","7SlKN"], "7SlKN", "parcelRequirea107")
